...
function HeaderHamburguer({darkMode, setDarkMode, showHamburguer, setShowHamburguer}) {
  
    
  return (
    
    <div 
    className="flex w-full justify-end absolute top-0"
   >
    {showHamburguer ? (
        ...
        <li className="flex"><DarkModeContainer darkMode={darkMode} setDarkMode={setDarkMode} setShowHamburguer={setShowHamburguer}/></li>
        <li className="py-10"><p className="text-lg">login</p></li>
        
        <li><p className="text-lg">register</p></li></ul>
        </section>
        )
    }
