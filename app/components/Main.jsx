...
{nextPage ? (<><HiOutlineChevronDoubleRight />
  <button onClick={()=>fetchMoviesPag2 (query)}> <p className="px-1">next</p> </button></>) : (<><HiOutlineChevronDoubleLeft />
  <button onClick={()=>fetchMovies (query)}> <p className="px-1">back</p> </button></>) }
 </div>
